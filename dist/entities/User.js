...
__decorate([
    (0, typeorm_1.Column)({ length: 255, nullable: false, select: false }),
    __metadata("design:type", String)
...
__decorate([
    (0, typeorm_1.Column)({ name: 'profile_image', type: 'varchar', length: 255, nullable: true }),
...
__decorate([
    (0, typeorm_1.OneToMany)(() => Recipes_1.Recipe, recipe => recipe.addedBy),
    __metadata("design:type", Array)
